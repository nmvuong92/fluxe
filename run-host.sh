...
( cd backends-native/host-go && PORT=$HOST_PORT FLUXE_UPSTREAM=http://127.0.0.1:$NODE_PORT FLUXE_MANIFEST=../../.fluxe/resolution.json FLUXE_STATIC=../../.fluxe/static.json go run . ) >/tmp/fluxe-host.log 2>&1 & pids+=($!)
