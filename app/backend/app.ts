...
/* Gom module (plugin) qua createApp — thin composer trên createHandler. Thêm feature =
 * thêm module vào mảng plugins. Trả { app, store, manifest } cho server + test dùng lại. */
